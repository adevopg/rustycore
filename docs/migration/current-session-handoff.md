...
- Latest completed committed slice: `#NEXT.R8.ENTITIES.409 — GameObject linked-trap loaded-grid pre-add and map-local removal seam`.
...
Overall core migration estimate after committed #409 GameObject linked-trap loaded-grid pre-add/map-local removal seam: `~89.6%` (was `~89.4%` after #408; do not claim >95% until ownership/runtime gaps below are substantially closed).
