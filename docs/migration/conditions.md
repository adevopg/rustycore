...
- [ ] Test: `IsPlayerMeetingCondition` evaluates each PlayerCondition.db2 sub-check in isolation (tabular; partial: compare/logic helpers, race/class/gender, spells/items/currency/auras, party/area snapshot checks).
