...
| L4 | Entities/Item (Inventory) | `src/server/game/Entities/Item/` + Player inventory | [inventory.md](inventory.md) | ⚠️ ~22% (base Item+Bag + Player storage/ObjectAccessor lookup; no ownership/runtime/DB) | ⚠️ |
