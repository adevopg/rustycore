...
- [ ] **#026e** `wow-packet`: `UF::ConversationData::WriteUpdate` VALUES serializer contra `UpdateFields.cpp`, incluyendo `Lines`, `Actors` `DynamicUpdateField` masks y `LastLineEndTime`.
