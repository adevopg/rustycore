...
- [ ] **#032** Refactor `WorldSession` para tener player entity handle/controlador en vez de campos sueltos.
  ...
  - [ ] **#032b** Migrar runtime de jugador al controlador/player entity.
    ...
    - [ ] **#032b2** Migrar `m_items`/buyback/inventory item objects al controlador/player entity sin depender de `WorldSession` como owner de inventario.
      ...
      - [ ] **#032b2c** Invertir el owner efectivo: los mutadores deben operar sobre `SessionPlayerInventoryRuntime` y los campos heredados de `WorldSession` deben quedar como espejo/compatibilidad hasta su retirada en `#032d`.
