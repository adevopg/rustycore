...
- [ ] **#026h** `wow-packet`: serializer VALUES completo para `UF::PlayerData::WriteUpdate`, incluyendo bit `IsQuestLogChangesMaskSkipped`, `Customizations`, `ArenaCooldowns`, `VisualItemReplacements`, `QuestLog`, `VisibleItems`, `AvgItemLevel` y `Field_3120`.
- [ ] **#026i** `wow-packet`: serializer VALUES completo para `UF::ActivePlayerData::WriteUpdate`, incluyendo máscaras de 48 bloques, `SkillInfo`, inventario/buyback, dinámicos de quests/titles/toys/transmog/traits, research y PVP info.
