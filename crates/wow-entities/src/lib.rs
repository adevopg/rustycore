...
pub use game_object::{
    ...
    GAMEOBJECT_DATA_CHEST_USE_GROUP_LOOT_RULES, GAMEOBJECT_LOOT_MODE_DEFAULT,
    GAMEOBJECT_TYPE_CHEST, GAMEOBJECT_TYPE_FISHING_HOLE, GAMEOBJECT_TYPE_GATHERING_NODE,
    GameObject, GameObjectDataUpdate, GameObjectDataValues, GameObjectLootSource,
    GameObjectTemplateData, GameObjectValuesUpdate, GoState, LootState, MAX_GAMEOBJECT_DATA,
};
pub use item::{
