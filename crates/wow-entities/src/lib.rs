...
pub use game_object::{
    ...
    GooberUseSource, ItemForgeUseSource, LootState, MAX_GAMEOBJECT_DATA, NewFlagDropUseSource,
    NewFlagUseSource, QuestgiverUseSource, SpellcasterUseSource, TrapUseSource, UiLinkUseSource,
};
pub use item::{
