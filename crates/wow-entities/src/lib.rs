...
pub use vehicle::{
    ...
    VehiclePassengerAddPlan, VehiclePassengerRelocation, VehiclePassengerRemovePlan,
    VehiclePassengerTransportReset, VehiclePendingEventRemovalPlan, VehiclePendingJoinAbort,
    VehicleRemoveAllPassengersPlan, VehicleResetPlan, VehicleSeat, VehicleSeatAddon,
    ...
    vehicle_accessory_install_plan_like_cpp, vehicle_base_movement_flags_like_cpp,
